 ...
 * 
 * @param p_payload[in,out] Pointer to the task's payload
 */
 ...
 * 
 * @param p_payload[in,out] Pointer to the response's payload
 */
 ...
 * the handler.
 * 
 * @param task[in] Pointer to the inbound task @c TicdTask struct
 * @param resp[out] Pointer to the outbound response @c TicdTask struct
 */
